...
const GovtOfficeList = () => {
  ...
  const offices = [
    { name: "Passport Seva Kendra", status: "Open", time: "9:00 AM – 5:00 PM" },
    { name: "RTO Office", status: "Busy", time: "10:00 AM – 4:00 PM" },
    { name: "Municipal Corporation", status: "Open", time: "9:30 AM – 4:30 PM" },
    { name: "Aadhar Service Center", status: "Limited", time: "10:00 AM – 3:00 PM" },
    { name: "Electricity Board Office", status: "Open", time: "9:00 AM – 5:00 PM" },
  ];
