...
//
//    // =========================================================================
//    // SLOT COLLISION CHECK — native SELECT FOR UPDATE (Step 2)
//    // =========================================================================
//
//    @Query(value =
...
//            "  AND t.status NOT IN ('CANCELLED','COMPLETED','NO_SHOW')")
//    List<Token> findActiveTokensWithSlotForDoctor(
//            @Param("doctorId") Long doctorId,
//            @Param("date") LocalDate date);
//
//    @Query("SELECT t FROM Token t " +
...
//            "  AND t.scheduledTime IS NOT NULL " +
//            "  AND t.status NOT IN ('CANCELLED','COMPLETED','NO_SHOW')")
//    List<Token> findActiveTokensWithSlotForBranchService(
//            @Param("branchServiceId") Long branchServiceId,
//            @Param("date") LocalDate date);
//
//    // =========================================================================
...
//
//    // =========================================================================
//    // TOKENS AHEAD — live estimated wait time
//    // =========================================================================
//
...
//
//    // =========================================================================
//    // CANCEL — null out slot fields to free the window
//    // =========================================================================
//
//    @Modifying
...
//            "WHERE t.user.id = :userId ORDER BY t.bookingDate DESC, t.createdAt DESC")
...
//
//    // =========================================================================
//    // POST-CANCELLATION RECALCULATION
//    // =========================================================================
//
//    @Query("SELECT t FROM Token t " +
//            "WHERE t.doctor.id = :doctorId AND t.bookingDate = :date " +
...
//    List<Token> findByBranchId(@Param("branchId") Long branchId);
//}
//
//
//
...
public interface TokenRepository extends JpaRepository<Token, Long> {
    ...
    // =========================================================================
    // SLOT COLLISION CHECK (kept for legacy/staff use)
    // =========================================================================
    ...
    // =========================================================================
    // TOKENS AHEAD — global (used as fallback)
    // =========================================================================
    ...
    // =========================================================================
    // ACTIVE TOKENS FOR USER ON DATE (for rule checks)
    // =========================================================================
